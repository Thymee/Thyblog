      ...
      <nav :class="[{'showup':menuShowUp},'navigator']" v-scroll="menuClickHandler">
        ...
        <!--<router-link class="navigator-button" to="/photograph" @click="menuShowUp=false">
         ...
         <span class="search"><i class="fa fa-search" aria-hidden="true"></i></span>
          <i class="fa fa-bars fa-2 nav-mobile" aria-hidden="true" @mouseover="inMenuArea=true" @mouseout="inMenuArea=false" v-click="menuClickHandler" v-show="!menuShowUp"></i>        </nav>
    </div>
  </div>
</header>
</template>
